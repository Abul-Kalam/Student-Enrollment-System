                  ...
                  <table id="order-listing" class="table table-striped" style="width:100%;">
                    ...
                    @foreach($all_student_info as $v_student)
                      <tr>
                          ...
                          <td><img src="{{URL::to($v_student->student_image)}}" height="50" width="60" style="border-radius: 50%";></td>
                          ...
                          <td>
                            <a href="{{URL::to('/student_view/'.$v_student->student_id)}}"><button class="btn btn-outline-primary">View</button>
                            </a>
                            <a href="{{URL::to('/student_edit/'.$v_student->student_id)}}"<button class="btn btn-outline-warning">Edit</button></a>
                            <a href="{{URL::to('/student_delete/'.$v_student->student_id)}}" id="delete"><button class="btn btn-outline-danger">
                            Delete</button></a>
                          </td>
                      </tr>
                    @endforeach
