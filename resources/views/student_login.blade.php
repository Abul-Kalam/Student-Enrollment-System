...
<head>
  ...
  <link rel="stylesheet" href="{{asset('node_modules/font-awesome/css/font-awesome.min.cs')}}s" />
            ...
            <div class="card-body px-5 py-5">
              ...
              <form method="post" action="{{ url('/studentlogin') }}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input"  placeholder="password"  name="student_password">
                </div>
